...
echo ""
echo "🔒 For HTTPS access, configure a reverse proxy (nginx/Apache) with SSL certificates"
echo "   Point your HTTPS traffic to http://localhost:5173 for the frontend"
echo "   Point your HTTPS traffic to http://localhost:3001 for the backend"
echo ""
