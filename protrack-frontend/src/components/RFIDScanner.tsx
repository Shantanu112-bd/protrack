...
import RFIDService, { RFIDScanResult, ProductMetadata } from '../services/RFIDService'
...
const RFIDScanner: React.FC<RFIDScannerProps> = ({
  ...
  const { account, isConnected, supplyChainContract } = useWeb3()
  ...
  return (
    <div className={`max-w-4xl mx-auto p-6 ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg`}>
      ...
      {/* Scanner Interface */}
      <div className="text-center mb-8">
        <div className={`relative inline-block p-8 rounded-full ${
      ...
      {/* Scan Results */}
      {scanResult && (
        <div className={`p-6 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'} mb-6`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className={`text-sm font-mono ${isDark ? 'text-gray-200' : 'text-gray-900'} break-all`}>
                {scanResult.rfidHash}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                  {scanResult.productExists ? 'Existing Product' : 'New Product'}
                </span>
              </div>
            </div>
        ...
        <div className={`p-6 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => setProductMetadata({ ...productMetadata, name: e.target.value })}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setProductMetadata({ ...productMetadata, batchNumber: e.target.value })}
                className={`w-full px-3 py-2 rounded-lg border ${
                  isDark 
                    ? 'bg-gray-800 border-gray-600 text-white' 
                    : 'bg-white border-gray-300 text-gray-900'
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setProductMetadata({ ...productMetadata, manufacturer: e.target.value })}
                className={`w-full px-3 py-2 rounded-lg border ${
                  isDark 
                    ? 'bg-gray-800 border-gray-600 text-white' 
                    : 'bg-white border-gray-300 text-gray-900'
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setProductMetadata({ ...productMetadata, category: e.target.value })}
                className={`w-full px-3 py-2 rounded-lg border ${
                  isDark 
                    ? 'bg-gray-800 border-gray-600 text-white' 
                    : 'bg-white border-gray-300 text-gray-900'
            ...
            <div>
              ...
              <input
                type="datetime-local"
                value={new Date(productMetadata.expiryDate).toISOString().slice(0, 16)}
                onChange={(e) => setProductMetadata({ ...productMetadata, expiryDate: new Date(e.target.value).getTime() })}
                className={`w-full px-3 py-2 rounded-lg border ${
                  isDark 
                    ? 'bg-gray-800 border-gray-600 text-white' 
                    : 'bg-white border-gray-300 text-gray-900'
          ...
          <div className="flex space-x-4">
            <button
              ...
              disabled={isTokenizing || !productMetadata.name || !productMetadata.batchNumber || !productMetadata.manufacturer}
              className={`px-6 py-3 rounded-lg font-semibold text-white transition-colors ${
                isTokenizing || !productMetadata.name || !productMetadata.batchNumber || !productMetadata.manufacturer
                  ? 'bg-gray-400 cursor-not-allowed'
