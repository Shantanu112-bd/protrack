...
const BlockchainIoTVerification: React.FC = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          {
            label: "Alerts (24h)",
            value: dashboardStats.alertsLast24h,
            icon: AlertTriangle,
            color: "yellow",
          },
          {
            label: "Data Points",
            value: dashboardStats.dataPointsToday,
            icon: Shield,
            color: "purple",
          },
        ].map((stat, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div
                      className={`px-2 py-1 rounded-full text-xs ${getDeviceStatusColor(
                        device.status
                      )}`}
                    >
                      {device.status}
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-900/50 border border-gray-600 rounded-lg p-4">
            <h4 className="text-md font-medium text-white mb-3">Verify Data</h4>
            <p className="text-sm text-gray-400 mb-4">
              Select a data point to verify its authenticity on the blockchain
            </p>
            ...
            <div className="space-y-3">
              {sensorData.slice(-5).map((data, index) => (
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      data.dataHash && verifyDataOnBlockchain(data.dataHash)
                    }
              ...
              {verificationResults.length > 0 ? (
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-sm text-white font-mono">
                          {result.dataHash.slice(0, 8)}...
                          {result.dataHash.slice(-4)}
                        </div>
                ...
                <div className="text-center py-8 text-gray-400">
                  ...
                  <p className="text-xs mt-1">
                    Verify data points to see results here
                  </p>
                </div>
              )}
            </div>
...
export default BlockchainIoTVerification;
