...
const RFIDScannerInterface: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/10 to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">RFID Scanner</h1>
          <p className="text-gray-400">
            Scan and tokenize products using RFID technology
          </p>
        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-gray-800/30 rounded-lg">
                    ...
                    <span className="text-green-400 font-bold">138</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-800/30 rounded-lg">
